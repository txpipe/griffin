...
mod tests {
    ...
    fn test_phase2_order_resolve() {
        ...
        let resolved_inputs = vec![
            ...
            Output {
                address: Address(
                    hex::decode("6101e6301758a6badfab05035cffc8e3438b3aff2a4edc6544b47329c4")
                        .unwrap(),
                ),
                value: Value::Coin(3),
                datum_option: None,
