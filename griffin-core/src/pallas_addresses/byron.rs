...
use crate::pallas_addresses::Error;
...
impl AddressPayload {
    pub fn hash_address_id(
        ...
        crate::pallas_crypto::hash::Hasher::<224>::hash(&sha3_256(&buf))
    }
    ...
    pub fn new_redeem(
        pubkey: crate::pallas_crypto::key::ed25519::PublicKey,
...
impl ByronAddress {
    ...
    pub fn from_bytes(value: &[u8]) -> Result<Self, Error> {
        crate::pallas_codec::minicbor::decode(value).map_err(Error::InvalidByronCbor)
    }
    ...
    pub fn to_vec(&self) -> Vec<u8> {
        crate::pallas_codec::minicbor::to_vec(self).unwrap()
    }
