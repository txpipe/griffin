...
use crate::pallas_codec::utils::{KeepRaw, KeyValuePairs, NonEmptyKeyValuePairs};
...
pub trait ComputeHash<const BYTES: usize> {
    fn compute_hash(&self) -> crate::pallas_crypto::hash::Hash<BYTES>;
}

pub trait OriginalHash<const BYTES: usize> {
    fn original_hash(&self) -> crate::pallas_crypto::hash::Hash<BYTES>;
}
